...
//            if (!TextUtils.isEmpty(bodyStr) && bodyStr.contains("status") && bodyStr.contains("msg")) {
//                JSONObject jsonObject = new JSONObject(bodyStr);
//                int status = jsonObject.getInt("status");
//                String msg = jsonObject.getString("msg");
//                if (status == -1 || status == 12110) {
//                    throw new MyException("{\"status\":" + status + ",\"msg\":\"" + msg + "\"}");
//                }
//            }
//        }
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != ResponseBean.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                response.close();
               boolean error = responseBean.error;
                //这里的0是以下意思
                ...
                if (!error) {
                    ...
                    throw new MyException("{\"error\":\"" + "出错了" + "\"}");
                }
